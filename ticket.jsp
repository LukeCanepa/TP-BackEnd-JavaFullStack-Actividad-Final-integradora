            ...
            <div class="col-lg-8 col-xl-7">
                ...
                <form action="update.jsp">
                    ...
                    <div class="row gx-2">
                        ...
                        <div class="col-md mb-3">
                            <label for="categoriaSelect" class="form-label"><u><i> Categoría </i></u></label>
...
<footer id="main-footer">
    <div class="container">
        <ul class="nav d-flex justify-content-between py-5">
            ...
            <li class="navbar-item"><a href="#" class="nav-link text-light">Contáctanos</a></li>
            ...
            <li class="navbar-item"><a href="#" class="nav-link text-light">Términos y <span>condiciones</span></a></li>
